...
const ReactCalendar = (props) => {
  ...
  return (
    <DefaultLayout {...props}>
      <p>
        <Link
          to='https://github.com/wojtekmaj/react-calendar/blob/main/packages/react-calendar/README.md'
          target='_blank'>
          react calendar
        </Link>
      </p>
      <p>
        <Link
          to='https://blog.logrocket.com/react-calendar-tutorial-build-customize-calendar/'
          target='_blank'>
          react calendar tutorial build-customize
        </Link>
      </p>
      <div
        style={{
        ...
        <div>
          <Calendar
            ...
            tileContent={({ date, view }) => {
              return view === 'month' && date.getDay() ? <TileContent /> : null;
            }}
          />
          <div>selected: {moment(value).format('YYYY년 MM월 DD일')}</div>
        </div>
